...
import { FaktoriaTabsComponent } from './faktoria-tabs.component'
...
@Component({
  selector: 'nwb-faktoria-detail-page',
  templateUrl: './faktoria-detail-page.component.html',
...
export class FaktoriaDetailPageComponent {
